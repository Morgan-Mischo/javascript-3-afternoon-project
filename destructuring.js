...
const {color = 'blue', make = 'bmw', model = '3 series', year = '2005'} = carDetails; 
...
function totalPopulation({utah : Lehi, california: LA, texas: Austin, arizona: Phoenix})
{
  return (Lehi + LA + Austin + Phoenix)
}
